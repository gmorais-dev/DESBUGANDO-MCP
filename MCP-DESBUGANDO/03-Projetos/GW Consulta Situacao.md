...
- JAR final: `gwConsultaSituacao.jar`.
...
O artefato `gwConsultaSituacao.jar` aparece em [[Libs complementares]] e pode ser consumido pelo [[Webtrans]]. Confirmar versao do JAR em runtime quando o sintoma persistir.
